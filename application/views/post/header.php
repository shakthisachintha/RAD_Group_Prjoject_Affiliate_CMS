                ...
                <div class="modal-body">
                    <form action="/user/login" method="post" id="log_form">
                        <div class="form-group">
                            ...
                            <input id="login_email" class="form-control bg-light border-dark lead" type="email" required name="email">
                        </div>

                        <div class="form-group">
                            <label for="password">Password</label>
                            <input id="login_password" class="form-control bg-light border-dark lead" type="password" required name="password">
                        </div>
                ...
                <div class="modal-body">
                    <form action="/user/reg" method="post" id="reg_form">
                        ...
                        <div class="form-group">
                            ...
                            <input id="reg_email" class="form-control bg-light border-dark lead" type="email" required name="email">
                        </div>

                        <div class="form-group">
                            <label for="reg_password">Password</label>
                            <input id="reg_password" class="form-control bg-light border-dark lead" type="password" required name="password">

                            <div class="mt-1 custom-control custom-checkbox">
                                <input type="checkbox" onchange="showPass()" class="custom-control-input" id="show_pass">
